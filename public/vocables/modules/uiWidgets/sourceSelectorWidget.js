...
class sourceSelector extends LitElement {
        ...
        return html`
            <div id="sourceSelector" style="margin-bottom: 10px; width: auto; min-height: 0px; max-height: none; height: 680px">
                <div class="sourceSelector_buttons">
                    <slsv-button id="" value="Cancel" action="close"></slsv-button>
                    <slsv-button id="sourceSelector_validateButton" value="OK"></slsv-button>
                </div>
                <div>Search : <slsv-input id="sourceSelector_searchInput" onkeydown="SourceSelectorWidget.searchBarEvent(event);" autocomplete="off"></slsv-input></div>
    ...
    //onkeydown="SourceSelectorWidget.searchBarEvent(event);"
    firstUpdated() {
        //super.firstUpdated();
...
var SourceSelectorWidget = (function () {
    ...
    self.searchBarEvent = function (event) {
    ...
    self.initJsTree = function () {
        ...
        $("#sourceSelector_validateButton").bind("click", function () {
            ...
            if (isDialog) {
                $("#" + SourceSelectorWidget.currentTreeDiv).dialog("close");
            }
        });
